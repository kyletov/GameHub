		...
		<main>
			...
			<form method="post">
				<table>
					...
					<tr><th><label id="confirm_password">Confirm Password</label></th><td> <input type="password" name="confirm_password" /></td></tr>
					<tr><th>&nbsp;</th><td><input type="submit" name="submit" value="register" /></td></tr>
					<tr><th>&nbsp;</th><td><?php echo(view_errors($errors)); ?></td></tr>
				</table>
				<button class="link" type="submit" name="submit" value="back">back</button>
			</form>
		</main>
		<footer>
		</footer>
